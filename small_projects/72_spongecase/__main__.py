...
class App(tk.Tk):
    ...
    def __init__(self, title: str) -> None:
        ...
        t_message = ScrolledText(f_left, width=20, height=5, font=self.text_font, spacing2=3, spacing3=3)
        ...
        t_spongecase = ScrolledText(f_right, width=20, height=5, font=self.text_font, spacing2=3, spacing3=3)
        ...
        b_clip = ttk.Button(f_buttons, text='sPoNgeCAsE to Clipboard')
